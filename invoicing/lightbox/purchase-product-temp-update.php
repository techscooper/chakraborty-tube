...
if($ckadmin==1){
  ...
  $quantity=get_single_value("purchase_product_item_temp","sl",$temp_sl,"quantity","");
?>
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <form id="updateFrm" name="updateFrm" action="invoicing-code/purchase-product-temp-update-2.php" method="POST">
...
<script type="text/javascript" src="invoicing-js/purchase-product-temp-update.js"></script>
<?php
}
?>