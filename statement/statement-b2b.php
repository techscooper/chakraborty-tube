...
<html lang="en">
  <head>
    ...
    <title>Statement B2B || <?php echo $projectName; ?></title>
  ...
  <body class="theme-blue">
      ...
      <div class="page">
        <div class="container-fluid">
          <div class="page_header">
            <div class="left"><h1>Statement B2B</h1></div>
            <div class="right">
    ...
    function getListShow(){
      ...
      setTimeout(function(){ $("#divList").load("jquery-pages/load-statement-b2b.php?fdt="+fdt+"&tdt="+tdt).fadeIn("fast") }, 1000);
    }
