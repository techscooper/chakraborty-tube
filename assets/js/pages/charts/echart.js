            ...
            data: [
                {
                    itemStyle:{
                        color: ArrOwlite.colors['teal'],
                        borderColor: ArrOwlite.colors['teal'],
                    },
                    value: [20, 30, 10, 35]
                },
                {
                    itemStyle:{
                        color: ArrOwlite.colors['blue'],
                        color0: ArrOwlite.colors['blue'],
                        borderColor: ArrOwlite.colors['blue'],
                        borderColor0: ArrOwlite.colors['blue'],
                    },
                    value: [40, 35, 30, 55]
                },
                {
                    itemStyle:{
                        color: ArrOwlite.colors['pink'],
                        borderColor: ArrOwlite.colors['pink'],
                    },
                    value: [33, 38, 33, 40]
                },
                {
                    itemStyle:{
                        color: ArrOwlite.colors['orange'],
                        borderColor: ArrOwlite.colors['orange'],
                    },
                    value: [40, 40, 32, 42]
                },
            ]
        ...
        series: [
            {
                ...
                data:[
                    {value:335, name:'Data1', itemStyle: {color: ArrOwlite.colors["blue-darkest"],}},
                    {value:310, name:'Data2', itemStyle: {color: ArrOwlite.colors["blue-dark"],}},
                    {value:234, name:'Data3', itemStyle: {color: ArrOwlite.colors["blue"],}},
                    {value:135, name:'Data4', itemStyle: {color: ArrOwlite.colors["blue-light"],}},
                    {value:1548, name:'Data5', itemStyle: {color: ArrOwlite.colors["blue-lightest"],}}
                ]
            }
        ]
    };
