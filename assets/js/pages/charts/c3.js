        ...
        $(document).ready(function(){
            var chart = c3.generate({
                ...
                data: {
                    ...
                    colors: {
                        'data1': ArrOwlite.colors["cyan"],
                        'data2': ArrOwlite.colors["blue"],
                        'data3': ArrOwlite.colors["green"]
                    },
                    names: {
                        // name of each serie
                        'data1': 'Development',
        ...
        $(document).ready(function(){
            var chart = c3.generate({
                ...
                data: {
                    ...
                    type: 'line', // default type of chart
                    colors: {
                        'data1': ArrOwlite.colors["blue"],
                        'data2': ArrOwlite.colors["cyan"]
                    },
                    names: {
                        // name of each serie
                        'data1': 'Tokyo',
        ...
        $(document).ready(function(){
            var chart = c3.generate({
                ...
                data: {
                    ...
                    colors: {
                        'data1': ArrOwlite.colors["blue-darker"],
                        'data2': ArrOwlite.colors["blue"],
                        'data3': ArrOwlite.colors["blue-light"],
                        'data4': ArrOwlite.colors["blue-lighter"]
                    },
                    names: {
                        // name of each serie
                        'data1': 'A',
        ...
        $(document).ready(function(){
            var chart = c3.generate({
                ...
                data: {
                    ...
                    colors: {
                        'data1': ArrOwlite.colors["cyan"],
                        'data2': ArrOwlite.colors["indigo"],
                        'data3': ArrOwlite.colors["green"],
                        'data4': ArrOwlite.colors["blue"]
                    },
                    names: {
                        // name of each serie
                        'data1': 'Development',
